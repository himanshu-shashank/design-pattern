package com.himanshu.simple.designpattern.behavioural.observer;

import com.himanshu.simple.designpattern.behavioural.observer.publisher.Publisher;
import com.himanshu.simple.designpattern.behavioural.observer.publisher.StockGrabber;
...
public class GetTheStock implements Runnable{
    ...
    public GetTheStock(Publisher stockGrabber, int newStartTime, String newStock, double newPrice){
    ...
    public void run(){
        ...
        for(int i = 1; i <= 20; i++){
            ...
            System.out.println(Thread.currentThread().getName()+" "+stock + ": " + df.format((price)) +
                    " " + df.format(randNum));
